                      ...
                      case "Awaiting": {
                          return Column(
                            ...
                            children: <Widget>[
                              SizedBox(height: 4,),
                              Text(
                                snapshot.data.documents[0]['callType'] == "VideoCall" ? "Incoming Video Call".tr().toString()
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    FloatingActionButton(
                                      ...
                                      child: Icon(
                                        snapshot.data.documents[0]['callType'] == "VideoCall"
                                          ? Icons.video_call
                                          : Icons.call,
                                        color: Colors.green,
                                      ),
                                      onPressed: () async {
                                        await handleCameraAndMic(snapshot.data.documents[0]['callType']);
                                        ispickup = true;
                                        await callRef.document(widget.callInfo['channel_id'])
                                          .updateData({'response': "Pickup"});
