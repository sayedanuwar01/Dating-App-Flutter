...
class OtpVerification extends StatefulWidget {
  ...
  OtpVerification(this.phoneNumber, this.smsVerificationCode, this.updateNumber);
            ...
            InkWell(
              ...
              onTap: () async {
                ...
                if (widget.updateNumber) {
                  FirebaseUser user = await FirebaseAuth.instance.currentUser();
                  user.updatePhoneNumberCredential(_phoneAuth)
                    .then((_) => updateNumber())
                    .catchError((e) {
                        CustomSnackbar.snackbar("Verification Failed", _scaffoldKey);
                      }
                    );
                }else {
