...
class _ChatPageState extends State<ChatPage> {
    ...
    return <Widget>[
      Expanded(
        child: Column(
          ...
          children: <Widget>[
            Container(
              child: documentSnapshot.data['image_url'] != '' ? InkWell(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: <Widget>[
                      new Container(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: documentSnapshot.data['isRead'] == false ? Icon(
                                Icons.done,
                      ...
                      Padding(
                        ...
                        child: Text(
                          documentSnapshot.data["time"] != null ? DateFormat.yMMMd('en_US')
                            .add_jm()
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Text(
                                documentSnapshot.data["time"] != null ? DateFormat.MMMd('en_US')
                                  .add_jm()
                                  .format(documentSnapshot.data["time"].toDate())
                                  .toString() : "",
                                style: TextStyle(
                              ...
                              SizedBox(width: 5,),
                              documentSnapshot.data['isRead'] == false ? Icon(
                                Icons.done,
                                color: secondaryColor,
                                size: 15,
                              ):
        ...
        children: <Widget>[
          InkWell(
            ...
            onTap: () => showDialog(
              ...
              context: context,
              builder: (context) {
                return UserInfoScreen(widget.second, widget.sender, );
              }
            ),
          ),
        ],
      ...
      .map<Widget>((doc) => Container(
        ...
        child: Row(
          ...
          children: doc.data['type'] == "Call" ? [
            Text(
              doc.data["time"] != null ? "${doc.data['text']} : "
              + DateFormat.yMMMd('en_US')
              .add_jm()
          ...
          doc.data['sender_id'] != widget.sender.id ? generateReceiverLayout(doc,):
                              ...
                              FlatButton(
                                onPressed: () async {
                                  ...
                                  if (isBlocked && blockedBy == widget.sender.id) {
                                    ...
                                    CustomSnackbar.snackbar("You can't unblock".tr().toString(), _scaffoldKey);
                                  }
                                },
          ...
          body: Stack(
            children: [
              Container(
                ...
                child: Image.asset(
                  'asset/images/chat_background.png',
                  width: MediaQuery.of(context).size.width,
                  fit: BoxFit.fitWidth,
                ),
              ),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: isBlocked ? Text("Sorry You can't send message!".tr().toString())
                        : _buildTextComposer(),
                    ),
                  ],
                ),
  ...
  Widget _buildTextComposer() {
    return IconTheme(
      data: IconThemeData(color: _isWritting ? primaryColor : secondaryColor),
      child: Container(
